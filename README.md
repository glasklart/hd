...
Since Version 4.9 we will use the Cydia tweak ClassicBadges from [Coolstar's Repo](http://repo.coolstar.org/). Please add the repo `http://coolstar.org/publicrepo/` to Cydia and install `ThemeLib` and `ClassicBadges`.
